<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
    <thead>
        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
            ...
            <th class="min-w-100px">Nama Hari</th>
            ...
            <th class="min-w-100px">Waktu Mulai</th>
            <th class="min-w-100px">Waktu Akhir</th>
    ...
    <tbody class="fw-bold text-gray-600">
        ...
        <tr>
            ...
            <td class="text pe-0">
                <span class="fw-bolder text-dark">{{ $item->food->day }}</span>
            </td>
            <td class="text pe-0">
            ...
            <td class="text pe-0">
                <span class="fw-bolder text-dark"><img src="{{ asset('images/menu/'.$item->image) }}" alt="" width="100px"></span>
            </td>
            <td class="text pe-0">
                <span class="fw-bolder text-dark">{{ $item->price }}</span>
            </td>
            <td class="text pe-0">
                <span class="fw-bolder text-dark">{{ $item->start }}</span>
            </td>
            <td class="text pe-0">
                <span class="fw-bolder text-dark">{{ $item->end }}</span>
            </td>
            <td class="text-end">
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" aria-labelledby="aksi">
                        <div class="menu-item px-3">
                            <a href="javascript:;" onclick="load_input('{{route('admin.list-food.edit',$item->id)}}');" class="menu-link px-3">Ubah</a>
                        </div>
                        <div class="menu-item px-3">
                            <a href="javascript:;" onclick="handle_delete('{{route('admin.list-food.destroy',$item->id)}}');" class="menu-link px-3">Hapus</a>
                        </div>
                    </div>
                </div>
            </td>
