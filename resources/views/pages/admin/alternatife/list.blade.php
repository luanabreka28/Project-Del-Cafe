<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
    ...
    <tbody class="fw-bold text-gray-600">
        ...
        <tr>
            ...
            <td class="text pe-0">
                <span class="fw-bolder text-dark">{{$item->day}} | {{$item->date}} | {{ $item->name_food }}</span>
            </td>
            <td class="text pe-0">
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" aria-labelledby="aksi">
                        <div class="menu-item px-3">
                            <a href="javascript:;" onclick="load_input('{{route('admin.alternatife.edit',$item->id)}}');" class="menu-link px-3">Ubah</a>
                        </div>
                        <div class="menu-item px-3">
                            <a href="javascript:;" onclick="handle_delete('{{route('admin.alternatife.destroy',$item->id)}}');" class="menu-link px-3">Hapus</a>
                        </div>
                    </div>
                </div>
            </td>
